...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='cfg/yolov3_576x320_v4.cfg', help='cfg file path')
    parser.add_argument('--weights', type=str, default='weights/run30_11_01_12/latest.pt', help='path to weights file')
    ...
    data_root = os.path.join('/home/sdb/wangshentao/myspace/thesis/data/visdrone_2019_mot/images/testc1')
    # data_root = os.path.join('/home/sdb/wangshentao/myspace/thesis/data/visdrone_2019_mot/images/valc1/')
    main(opt,
         data_root=data_root,
         seqs=seqs,
