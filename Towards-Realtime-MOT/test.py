...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='cfg/data.json', help='data config')
    parser.add_argument('--weights', type=str, default='weights/run21_11_12_40/latest.pt', help='path to weights file')
