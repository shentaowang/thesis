...
def train(
    ...
    weights_to_cfg = osp.join(weights_to, 'cfg')
    mkdir_if_missing(weights_to_cfg)
    if resume:
    ...
    for epoch in range(epochs):
        ...
        copyfile(data_cfg, weights_to + '/cfg/data.json')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-cfg', type=str, default='cfg/data.json', help='coco.data file path')
