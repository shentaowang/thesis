...
def convert_test_dev():
    ...
    out_dir = "/home/sdb/wangshentao/myspace/thesis/data/VisDrone2019-MOT-test-dev/annotations-c1"
...
def convert_val():
    ...
    out_dir = "/home/sdb/wangshentao/myspace/thesis/data/VisDrone2019-MOT-val/annotations-c1"
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)
    for file in os.listdir(annotation_dir):
        fin = open(os.path.join(annotation_dir, file), 'r')
