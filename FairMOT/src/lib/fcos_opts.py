...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--exp_id', default='0901-hrnet-mot-2-noid')
    ...
    # model
    self.parser.add_argument('--arch', default='dlav3_34',
                             help='model architecture. Currently tested'
                                  'resdcn_34 | resdcn_50 | resfpndcn_34 |'
                                  'dla_34 | dlav2_34 | hrnet_32 | fcoshrnet_18 |fcosdla_34')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/sdb/wangshentao/myspace/thesis/data')
    ...
    self.parser.add_argument('--centerness_weight', type=float, default=1,
                             help='loss weight for centerness.')
    self.parser.add_argument('--bbox_weght', type=float, default=1.0,
