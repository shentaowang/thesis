...
# def gen_annotation():
#     seq_root = '/home/sdb/wangshentao/myspace/thesis/data/d435i/images/2020-12-17/'
#     annotations = '/home/sdb/wangshentao/myspace/thesis/data/d435i/annotations/'
#     label_root = '/home/sdb/wangshentao/myspace/thesis/data/d435i/labels_with_ids/2020-12-17/'
#     mkdirs(label_root)
#     # seqs = [s for s in os.listdir(seq_root)]
#     seqs = ['2020-12-17-15-12-54-2-0', '2020-12-17-15-12-54-2-1', '2020-12-17-15-12-54-2-2']
#     seq_width = 424
#     seq_height = 240
#
#     for seq in seqs:
...
#             tid = int(line[2])
#             x, y, w, h = int(line[3]), int(line[4]), int(line[5]), int(line[6])
...
#             x += w/2
#             y += h/2
#             label_str = '0 {:d} {:.6f} {:.6f} {:.6f} {:.6f}\n'.format(tid, x/seq_width, y/seq_height,
...
def gen_test_data():
    ...
    mkdirs(label_root)
    # seqs = [s for s in os.listdir(seq_root)]
    seqs = ['2020-12-17-15-12-54-1-2', '2020-12-17-15-12-54-2']
    seq_width = 424
    seq_height = 240
    for seq in seqs:
        print(seq)
...
def rename_files():
    ...
    for seq in seqs:
        ...
        for color_image_file in color_image_files:
            ...
            shutil.copy(os.path.join(seq_root, seq + '-' + data_dir, file),
                        os.path.join(save_data_dir, "{:0>7d}.pickle".format(frame_id)))
            shutil.copy(os.path.join(seq_root, seq + '-' + depth_image_dir, file),
