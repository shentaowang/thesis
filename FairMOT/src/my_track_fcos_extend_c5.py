...
from tracker.multitracker_extend_v3_c5 import JDETracker, FcosJDETracker
...
if __name__ == '__main__':
    ...
    opt.load_model = '../exp/mot/1130-fcos-litedla-c5/model_30.pth'
    opt.arch = 'dlav3_34'
    opt.conf_thres = 0.3
    opt.nms_thres = 0.4
    ...
    main(opt,
         data_root=data_root,
         seqs=seqs,
         exp_name='fcos_dlav3_extend_c5_1130_nms0.4_conf0.6',
         show_image=False,
         save_images=True,
         save_videos=False)
