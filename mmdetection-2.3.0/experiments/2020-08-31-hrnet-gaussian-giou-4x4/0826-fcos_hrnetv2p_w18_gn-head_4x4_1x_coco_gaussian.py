...
data = dict(
    ...
    test=dict(
        type='DroneDataset',
        ann_file=
        '/home/sdb/wangshentao/myspace/thesis/data/visdrone2019/VisDrone2019-DET-dev/instances_dev2019.json',
        img_prefix=
        '/home/sdb/wangshentao/myspace/thesis/data/visdrone2019/VisDrone2019-DET-dev/dev2019/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
test_cfg = dict(
    ...
    max_per_img=1000)
work_dir = 'experiments/2020-08-31-hrnet-gaussian-giou-4x4'
gpu_ids = range(0, 1)
