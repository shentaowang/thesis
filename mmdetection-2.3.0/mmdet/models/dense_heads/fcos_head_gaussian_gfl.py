...
class FCOSHeadGaussianGFL(AnchorFreeHead):
    ...
    def loss(self,
        ...
        flatten_centerness = [
            torch.zeros((i.shape[0]), device=i.device) for i in flatten_cls_scores
        ]
        ...
        if num_pos > 0:
            ...
            flatten_centerness[pos_inds] = pos_centerness_targets
            ...
            loss_cls = self.loss_cls(
                flatten_cls_scores, (flatten_labels, flatten_centerness))
        else:
